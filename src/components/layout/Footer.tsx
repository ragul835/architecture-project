...
export function Footer() {
  return <footer className="bg-[var(--charcoal)] py-14 text-[#f4f0e8]">
    <div className="page-shell grid gap-10 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div><p className="mb-4 text-xs font-bold uppercase tracking-[0.18em] text-[var(--sand)]">Explore</p><ul className="space-y-3 text-sm"><li><Link href="/services">Services</Link></li><li><Link href="/portfolio">Portfolio</Link></li><li><Link href="/about">About</Link></li><li><Link href="/contact">Contact</Link></li></ul></div>
